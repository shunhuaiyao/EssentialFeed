    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case (.success(.none), .success(.none)),
                (.failure, .failure):
                break
            case let (.success(.some(retrievedCachedFeed)), .success(.some(expectedCachedFeed))):
                XCTAssertEqual(retrievedCachedFeed.feed, expectedCachedFeed.feed, file: file, line: line)
                XCTAssertEqual(retrievedCachedFeed.timestamp, expectedCachedFeed.timestamp, file: file, line: line)
            default:
